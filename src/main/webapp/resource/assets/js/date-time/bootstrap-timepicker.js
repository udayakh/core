...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTime: function() {
      ...
      return this.hour + 'h ' + (this.minute.toString().length === 1 ? '0' + this.minute : this.minute) + (this.showSeconds ? 'm ' + (this.second.toString().length === 1 ? '0' + this.second : this.second) : '') +'s'+ (this.showMeridian ? ' ' + this.meridian : '');
    },
